...
echo Basics::addSpaces(5) . "<title>". Basics::$INF_TITLE . " - Installation</title>\n";
echo Basics::addSpaces(5) . "<meta http-equiv='Content-Type' content='text/html; charset=iso-8859-1' />\n";
...
echo Basics::addSpaces(5) . "<div id='header'>". Basics::$INF_TITLE . " - Installation</div>\n";
